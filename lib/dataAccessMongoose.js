...
/*
 * Global database error handler. Mainly used to trace a database failure for later inspection.
 * @param [callback] function to call after execution
 * @return [errorCode] errCodes.DATABASE_FAILURE if there was a failure, null if there was none
 */
 ...
 * @param [callback] function to call after execution
 * @return [errorCode] error code indicating whether user was found or not
 ...
 * @param [callback] function to call after execution
 * @return [errorCode] an error code indicating whether the user was registered or not
 */
